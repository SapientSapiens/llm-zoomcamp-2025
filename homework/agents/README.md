...
### __Answer: "Update or add weather information for a given city in the database."__

|                             |                              |                              |
|-----------------------------|------------------------------|------------------------------|
| ![alt text](images/ek.png)  | ![alt text](images/dui.png)  | ![alt text](images/tini.png) |
...
- What did you get in response?
   ...
   ### __Answer: {"jsonrpc":"2.0","id":3,"result":{"content":[{"type":"text","text":"20.0"}],"structuredContent":{"result":20.0},"isError":false}}__
